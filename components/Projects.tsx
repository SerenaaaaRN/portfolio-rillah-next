...
import { StaggerContainer, FadeUp, ZoomIn } from "@/lib/variants";
      ...
      >
        {projects.map((project, idx) => (
          <motion.div
            key={project.title}
            variants={ZoomIn}
            className="group flex flex-col h-full bg-white rounded-2xl border border-slate-100 shadow-soft overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
          >
